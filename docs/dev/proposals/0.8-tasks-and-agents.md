...
Status: **accepted in direction, decisions recorded 2026-09-18** (§10).
Nothing here is in `PROJECT_PLAN.md` yet. M30 moves it into the plan (§1,
§4.12–§4.15, §5.1, §6, §8, §9, §11, §12e), and only then does code start.
